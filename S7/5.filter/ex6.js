...
caracter 'Legends' en su propiedad .gameMorePlayed. Recomendamos usar la funcion .includes() para la
comprobación.
...
const xStreamers = streamers.filter(streamer => streamer.gameMorePlayed.includes("Legends") && streamer.age > 35 ?
streamer.gameMorePlayed = streamer.gameMorePlayed.toUpperCase() : streamer.gameMorePlayed);

console.log(xStreamers);
